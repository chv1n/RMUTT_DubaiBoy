...
| scrap_factor | number | Yes | **เปอร์เซ็นต์การสูญเสีย (ส่งเป็น % เช่น 20)** - backend จะแปลงเป็นทศนิยม 0.20 อัตโนมัติ |
...
> **⚠️ หมายเหตุ:** `scrap_factor` ส่งเป็นเปอร์เซ็นต์ เช่น ส่ง `20` หมายถึง 20% (backend จะเก็บเป็น `0.20`)
